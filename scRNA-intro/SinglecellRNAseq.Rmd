...
unfiltVsfilt_heatmap_plot <- ggplot(data = jaccard_df, aes(unfilt, filt, fill = jaccard_similarity)) +
  ...
  labs(title = "droputils vs. 10x",fill = "Jaccard Similarity") +
